# CLAUDE.md — agent guide for Garlemald Client
...
[`AGENTS.md`](AGENTS.md)** — it is the twin of this file. Keep the two in sync when
you change one.
...
6. Keep this file and [`AGENTS.md`](AGENTS.md) **in sync**.
